  ...
  return (
    <div style={{ background: "#fff", minHeight: "100vh" }}>
            ...
            <div className="rounded-2xl p-4" style={{ background: "#0F1728" }}>
              ...
              <div className="space-y-2 mb-4">
                <div className="rounded-lg p-3" style={{ background: "#1A2436" }}>
                  ...
                  <div className="text-xs font-mono" style={{ color: "#9CA3AF" }}>{`{ "email": "amaka@startup.ng", "plan_id": "plan_...", "external_id": "user_123" }`}</div>
                </div>
      ...
      <section id="how" className="px-10 py-20 max-w-5xl mx-auto">
        ...
        <p className="text-lg mb-12" style={{ color: "#6B7280" }}>No billing engineer required. No months of work. One API call and a webhook listener.</p>
      ...
      <section id="intelligence" className="px-10 py-20 max-w-5xl mx-auto">
        <div className="text-sm font-bold uppercase tracking-wider mb-3" style={{ color: "#00B37E" }}>Billing intelligence</div>
        <h2 className="text-4xl font-extrabold mb-4" style={{ color: "#0F1728", letterSpacing: "-0.02em" }}>
          Know which customers are about to churn.<br />Before they actually do.
        </h2>
        <p className="text-lg mb-12 max-w-2xl" style={{ color: "#6B7280" }}>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-4xl font-extrabold mb-4" style={{ color: "#0F1728", letterSpacing: "-0.02em" }}>
                Customers self-serve.<br />You stop answering billing emails.
              </h2>
              ...
              <ul className="space-y-3 mb-6">
                {[
                  ...
                  <li key={item} className="flex items-start gap-2.5 text-sm font-medium" style={{ color: "#4B5563" }}>
                    <i className="ti ti-check flex-shrink-0 mt-0.5" style={{ fontSize: 16, color: "#00B37E" }} />
                    {item}
                  </li>
                ))}
              </ul>
      ...
      <section className="px-10 py-20 max-w-5xl mx-auto">
        ...
        <div className="rounded-2xl p-5 border" style={{ borderColor: "#E5E7EB", background: "#F8F9FA" }}>
          ...
          <p className="text-sm font-medium leading-relaxed" style={{ color: "#4B5563" }}>
            Every financial event (every charge, refund, credit, and adjustment) writes one immutable row to the ledger. Nothing is ever edited or deleted. If your investor asks &quo;show me exactly where this number comes from&quo;, you can show them the exact entries behind it. That is the level of financial trust Tori is built to provide.
          </p>
        </div>
      </section>
      ...
      <section className="px-10 py-16 border-t" style={{ borderColor: "#F0F0F0", background: "#FAFAF8" }}>
        <div className="max-w-5xl mx-auto">
          ...
          <h2 className="text-4xl font-extrabold mb-4" style={{ color: "#0F1728", letterSpacing: "-0.02em" }}>
            Your product talks to Tori.<br />Tori talks to Nomba.
          </h2>
          <p className="text-lg mb-10 max-w-2xl" style={{ color: "#6B7280" }}>
            ...
            {[
              ...
              <div key={item.label} className="flex items-center gap-4">
                <div className="text-center">
                  <div className="w-16 h-16 rounded-2xl flex items-center justify-center mb-2 mx-auto" style={{ background: item.bg }}>
                    <i className={`ti ${item.icon}`} style={{ fontSize: 28, color: item.color }} />
                  </div>
                ...
                {i < 3 && (
                  <div className="flex items-center gap-1">
                    <div className="w-8 h-0.5" style={{ background: "#E5E7EB" }} />
      ...
      <section className="mx-10 my-16 rounded-2xl p-14 text-center max-w-5xl xl:mx-auto" style={{ background: "#0F1728" }}>
        ...
        <p className="text-base mb-8" style={{ color: "#6B7280" }}>
          Built on Nomba. Free to start. One API call to go live.
        </p>
        <div className="flex gap-3 justify-center">
          ...
          <Link href="/docs" className="inline-flex items-center gap-2 px-8 py-4 rounded-lg font-bold text-[15px] border" style={{ borderColor: "#374151", color: "#9CA3AF" }}>
            Read the docs
          </Link>
        </div>
      </section>
